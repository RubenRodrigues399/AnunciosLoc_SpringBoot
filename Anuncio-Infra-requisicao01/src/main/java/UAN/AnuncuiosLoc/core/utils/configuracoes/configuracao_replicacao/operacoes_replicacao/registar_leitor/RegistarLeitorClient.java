...
// @Component
// public class RegistarLeitorClient {
//     private final Jaxb2Marshaller marshaller;

//     public RegistarLeitorClient(Jaxb2Marshaller marshaller){
//         this.marshaller = marshaller;
//     }

//     public int registarLeitorNoServidorSlave(LeitorRegisto request, String  urlServidor) {
//         WebServiceTemplate template = new WebServiceTemplate(marshaller);
//         System.out.println("== REGISTAR LEITOR NO SLAVE: ");
...
//                         new SoapActionCallback("http://ws.anuncios.com/local/LeitorRegisto"));
