package UAN.AnuncuiosLoc.core.utils.configuracoes.configuracao_webservice;
...
@Configuration
@EnableWs
@ComponentScan(basePackages = "UAN.AnuncuiosLoc.features.feature_anuncio.adaptacao")
